...
from carpole_copy import train, test
...
def parse_args(args=sys.argv[1:]):
    ...
    parser.add_argument("--train_episodes", type=int, default=1000, #500,
    ...
    parser.add_argument("--desired_x", type=float, default=-1.9,
                        help="desired point for third reward function, should be in (-2.1, 2.1)")
